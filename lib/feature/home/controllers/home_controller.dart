...
class HomeController extends GetxController {
  ...
  void filterProjects(String category) {
    ...
    if (category == 'All') {
      ...
      filteredProjects.assignAll(
        _allProjects.where((p) => p.category == category),
      );
    }
  }
  ...
  void prevTestimonial() {
    final count = testimonials.length;
    testimonialIndex.value = (testimonialIndex.value - 1 + count) % count;
  }
  ...
  List<ProjectModel> _buildProjects() => [
    const ProjectModel(
      id: '1',
      title: 'Navelle Health',
      description:
          'Tracking women health and their fitness with ai support '
          'payment integration, and symptom tracking. Built with Flutter and GetX.',
      imageUrl: '',
      technologies: ['Flutter', 'GetX', 'Firebase', 'Stripe', "AI Chatbot"],
      githubUrl: '',
      liveDemoUrl:
          'https://play.google.com/store/search?q=Navelle%20Health&c=apps&hl=en',
      category: 'Mobile',
      isFeatured: true,
    ),
    const ProjectModel(
      ...
      githubUrl: '',
      liveDemoUrl:
          "https://drive.google.com/drive/folders/1szv3khlzEXr6qmjtvKWxgdZXa85wyi5a",
      category: 'Mobile',
    ),
    const ProjectModel(
      id: '3',
  ...
  List<SkillModel> get skills => [
    ...
    SkillModel(
      ...
      percentage: 0.96,
      color: const Color.fromARGB(255, 89, 245, 58),
      category: 'Design',
    ),
    SkillModel(
      name: 'SQLite / Hive',
  ...
  List<ExperienceModel> get experiences => [
    const ExperienceModel(
      company: 'Softvence Agency(Betopia).',
      position: 'Junior Flutter Developer',
      duration: '19 Jun 2024 - Present',
      description:
  ...
  List<ServiceModel> get services => [
    ...
    const ServiceModel(
      ...
      description:
          'Pixel-perfect implementation of Figma designs with '
